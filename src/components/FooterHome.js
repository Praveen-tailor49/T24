        ...
        <>
          ...
          ">
                        ...
                        <div class="">
                            ...
                            <p class="mb-4 ">
                                <a href="#!" class="text-gray-600">Phone</a>
                            </p>
                            <p class="mb-4 flex justify-center md:justify-start">
                                <a href="#!" class="text-gray-600">Charger</a>
                            </p>
                            <p class="mb-4 flex justify-center md:justify-start">
                                <a href="#!" class="text-gray-600">Eir Phone</a>
                            </p>
                        </div>
                        <div class="">
                            <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
